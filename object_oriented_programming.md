...
Vala provides inheritance functionality to any type of class (see [Classes/Types of class](types_of_classes.md) ). Given the following definition, every SubType instance is-a SuperType instance:
