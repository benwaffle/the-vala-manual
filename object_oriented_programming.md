...
Vala provides inheritance functionality to any type of class (see [Classes/Types of class](Classes#Types_of_class) ). Given the following definition, every SubType instance is-a SuperType instance:
